...
python3 infer_sem.py --cfg config/s2d3d_sem/HOHO_depth_dct_efficienthc_TransEn1_h1024_fold1_resnet101rgb.yaml --pth ckpt/s2d3d_sem_HOHO_depth_dct_efficienthc_TransEn1_h1024_fold1_resnet101rgb/ep60.pth --out assets/ --inp $IMAGE_FILE
